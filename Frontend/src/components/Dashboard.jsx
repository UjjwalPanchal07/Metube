    ...
    <div>
      ...
      <div className="border mt-10 mx-2">
        <div className="flex border px-4">
          <h1 className="w-[40%] text-white font-semibold text-lg text-center">Your Videos</h1>
          <h1 className="w-[15%] text-white font-semibold text-lg text-center">Status</h1>
          <h1 className="w-[15%] text-white font-semibold text-lg text-center">Views</h1>
          <h1 className="w-[15%] text-white font-semibold text-lg text-center">Likes</h1>
          <h1 className="w-[15%] text-white font-semibold text-lg text-center">Edit / Delete</h1>
        </div>
        <div>
          {videos.map((video) => (
            <DashboardVideoList key={video._id} video={video} onDelete={handleDelete} />
          ))}
        </div>
